...
if (MSVC)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        ...
        # Linker settings..
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SAFESEH /NXCOMPAT /DYNAMICBASE /DEBUG /INCREMENTAL /SUBSYSTEM:CONSOLE")
        set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} /SAFESEH /NXCOMPAT /DYNAMICBASE /DEBUG /INCREMENTAL /DLL /SUBSYSTEM:WINDOWS")
    else()
        # Compiler settings..
        list(APPEND FLAGS_AND_DEFINES
        ...
        # Linker settings..
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SAFESEH /LTCG:incremental /NXCOMPAT /DYNAMICBASE /OPT:REF /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /OPT:ICF /DEBUG:NONE /NOCOFFGRPINFO")
        set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} /SAFESEH /LTCG:incremental /NXCOMPAT /DYNAMICBASE /OPT:REF /INCREMENTAL:NO /DLL /SUBSYSTEM:WINDOWS /OPT:ICF /DEBUG:NONE /NOCOFFGRPINFO")
    endif()
endif()
